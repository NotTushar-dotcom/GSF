...
const EXPERTS = [
  { name: "Dr. Anika Patel", role: "Partner, Sequoia Capital India", domain: "Venture Capital", tags: ["Fundraising", "SaaS", "EdTech"], bio: "10+ years investing in early-stage startups. Led investments in 40+ companies including 3 unicorns.", initials: "AP", sessions: 48, rating: 4.9, available: true },
  { name: "James Whitfield", role: "Co-founder, Razorpay (exited)", domain: "Fintech & Scaling", tags: ["Product", "Scale", "B2B"], bio: "Built Razorpay from 0 to $1B valuation. Now advising the next generation of fintech founders.", initials: "JW", sessions: 62, rating: 5.0, available: true },
  { name: "Sara Mensah", role: "Director of Product, Stripe", domain: "Product Strategy", tags: ["Product Strategy", "APIs", "Growth"], bio: "Scaled Stripe's developer platform to 10M+ developers. Ex-Google, ex-Airbnb.", initials: "SM", sessions: 35, rating: 4.8, available: false },
  { name: "Raj Devani", role: "General Counsel, YC S22 Startup", domain: "Legal & IP", tags: ["Startup Law", "IP", "Fundraising Docs"], bio: "Specialized in startup formation, equity structuring, and IP for early-stage companies.", initials: "RD", sessions: 29, rating: 4.7, available: true },
  { name: "Yuki Tanaka", role: "Head of Growth, Notion", domain: "Growth & PLG", tags: ["PLG", "B2C", "Virality"], bio: "Pioneered product-led growth at Notion. Grew Notion from 1M to 30M users in 18 months.", initials: "YT", sessions: 41, rating: 4.9, available: true },
  { name: "Fatima Al-Hassan", role: "CEO, MedTech Africa", domain: "HealthTech & Impact", tags: ["HealthTech", "Impact", "Africa"], bio: "Building healthcare infrastructure for underserved markets. WHO Young Innovator 2023.", initials: "FA", sessions: 22, rating: 4.9, available: false },
];
      ...
      <main className="pt-24 min-h-screen bg-[#FDFAF7]">
        ...
        <section className="relative section-padding bg-soft-pattern overflow-hidden">
          ...
          <div className="section-container relative z-10 text-center">
            ...
            <p className="text-xl text-[#4A5668] max-w-2xl mx-auto mb-8">
              Book video calls and chat directly with operators, investors, and domain experts. No gatekeeping — available directly to every GSF member.
            </p>
            <div className="flex items-center gap-3 max-w-md mx-auto">
              ...
              <Link href="/connect" className="btn-primary whitespace-nowrap">Book a Call</Link>
            </div>
          </div>
        </section>

        {/* Grid */}
        <section className="section-container pb-24 pt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {EXPERTS.map((expert) => (
              <div key={expert.name} className="card p-6 card-hover flex flex-col gap-4">
                <div className="flex items-start gap-3">
                  <div className="size-12 rounded-full bg-[#EEF4F9] border border-[#AACDDC] flex items-center justify-center text-sm font-bold text-[#3D74A0] shrink-0">
                    {expert.initials}
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-2">
                      <h2 className="text-sm font-semibold text-[#1A2332] truncate">{expert.name}</h2>
                    ...
                    <p className="text-xs text-[#4A5668] truncate">{expert.role}</p>
        ...
        <section className="bg-[#F7F2EC] border-t border-[#D2C4B4] py-20">
          <div className="section-container text-center max-w-2xl mx-auto">
            ...
            <Link href="/contact" className="btn-primary px-8 py-3">Apply as an expert</Link>
          </div>
        </section>
      </main>
      <Footer />
